...
const props = defineProps<TraceAuthenticDeclarationToggleProps>()
...
const toggleProps = computed(() => ({
  ...attr,
  ...props,
  description: props.description ?? t('student.traces.interactions.toggles.TraceAuthenticDeclarationToggle.description'),
}))
</script>
