...
import { useDeclaredProgramFormValidators } from '@/features/student/declaredPrograms/composables/use-declared-program-form-validators/use-declared-program-form-validators'
...
export function useAddDeclaredProgramForm (onProgramAdded?: () => void) {
  ...
  const onCreateDeclaredProgramError = (error: BaseApiException) => {
    addErrorMessage({
      title: t('student.declaredPrograms.overlays.AddDeclaredProgramDrawer.errors.createDeclaredProgram'),
