import DeclaredProgramLinkInput from '@/features/student/declaredPrograms/components/interactions/inputs/DeclaredProgramLinkInput/DeclaredProgramLinkInput.vue'
