import AdditionalSkillSettingDropdown from '@/features/student/additionalSkills/views/StudentAdditionalSkillView/components/AdditionalSkillSettingDropdown/AdditionalSkillSettingDropdown.vue'
import { AvDropdownStub, BddTest } from '@avenirs-esr/avenirs-dsav/test-utils'
import { mount, type VueWrapper } from '@vue/test-utils'
import { beforeEach, expect } from 'vitest'

BddTest().given('an additional skill setting popover', () => {
  let wrapper: VueWrapper<InstanceType<typeof AdditionalSkillSettingDropdown>>
  ...
  beforeEach(() => {
    wrapper = mount(AdditionalSkillSettingDropdown, { global: { stubs } })
  })
