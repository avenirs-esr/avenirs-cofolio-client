...
import AdditionalSkillCommentInput from './AdditionalSkillCommentInput.vue'

BddTest().given('an additional skill comment input', () => {
  let wrapper: VueWrapper<InstanceType<typeof AdditionalSkillCommentInput>>
