import StudentProjectExperiencesSideMenuContent from '@/features/student/global/views/StudentProjectExperiencesView/components/StudentProjectExperiencesSideMenuContent/StudentProjectExperiencesSideMenuContent.vue'
