...
BddTest().given('a declared skill associate elements dropdown', () => {
  let wrapper: VueWrapper<InstanceType<typeof DeclaredSkillAssociateElementsDropdown>>
  ...
  BddTest().when('the component is mounted', () => {
    beforeEach(() => {
      wrapper = mount(DeclaredSkillAssociateElementsDropdown, { global: { stubs } })
    })
