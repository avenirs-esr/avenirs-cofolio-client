...
import StudentSkillsWidget from '@/features/student/skills/components/widgets/StudentSkillsWidget/StudentSkillsWidget.vue'
...
vi.mock('@/features/student/skills/queries/use-skills-view.query/use-skills-view.query', () => ({
