...
const menuItems = computed<AvDropdownItem[]>(() => {
  const items = [
    {
      ...
      label: t('student.global.views.studentProjectTrajectoriesView.selfKnowledge.categoryElementsPaginator.buttons.add')
    },
    {
      name: SelfKnowledgeElementsDropdownEvents.DELETE,
      icon: MDI_ICONS.TRASH_CAN_OUTLINE,
      label: t('student.global.views.studentProjectTrajectoriesView.selfKnowledge.categoryElementsPaginator.buttons.delete')
    },
    {
      name: SelfKnowledgeElementsDropdownEvents.SHARE,
      icon: MDI_ICONS.SHARE_VARIANT_OUTLINE,
      label: t('student.global.views.studentProjectTrajectoriesView.selfKnowledge.categoryElementsPaginator.buttons.share')
    }
  ]
  ...
  if (isCategoryDeletable.value) {
    items.push({
      ...
      icon: MDI_ICONS.TRASH_CAN_OUTLINE,
      label: t('student.global.views.studentProjectTrajectoriesView.selfKnowledge.categoryElementsPaginator.buttons.deleteCategory')
    })
  }
