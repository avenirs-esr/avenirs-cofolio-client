...
import AmsListContainer from '@/features/student/ams/views/StudentEducationAmsView/components/AmsListContainer/AmsListContainer.vue'
import { ProgramProgressSelectorStub } from '@/features/student/ams/views/StudentEducationAmsView/components/ProgramProgressSelector/ProgramProgressSelect.stub'
import { StudentDetailedAmsCardStub } from '@/features/student/ams/views/StudentEducationAmsView/components/StudentDetailedAmsCard/StudentDetailedAmsCard.stub'
...
vi.mock('@/features/student/ams/queries/use-ams-view.query/use-ams-view.query', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@/features/student/ams/queries/use-ams-view.query/use-ams-view.query')>()
  return {
    ...actual,
