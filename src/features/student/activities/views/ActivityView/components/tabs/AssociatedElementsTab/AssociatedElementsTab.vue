...
import TraceAssociationLimitCard
  from '@/features/student/activities/views/ActivityView/components/cards/TraceAssociationLimitCard/TraceAssociationLimitCard.vue'
import AssociateDeclaredSkillToActivityModal
  from '@/features/student/activities/views/ActivityView/components/modals/AssociateDeclaredSkillToActivityModal/AssociateDeclaredSkillToActivityModal.vue'
import AssociateTracesToDeclaredActivity
  from '@/features/student/activities/views/ActivityView/components/overlays/modals/AssociateTracesModal/AssociateTracesToDeclaredActivity.vue'
import DeleteActivityAssociatedElementsModal
  from '@/features/student/activities/views/ActivityView/components/overlays/modals/DeleteActivityAssociatedElementsModal/DeleteActivityAssociatedElementsModal.vue'
...
<template>
  <div class="av-col av-gap-xl av-pt-xl">
    <div class="av-col av-gap-sm">
      ...
      >
        {{ t('student.activities.views.ActivityView.AssociatedElementsTab.maxTraceAssociationsReached') }}
      </span>
    </div>
