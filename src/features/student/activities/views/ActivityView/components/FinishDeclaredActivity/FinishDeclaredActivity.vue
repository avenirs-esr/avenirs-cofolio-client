...
import FinishDeclaredActivityConfirmModal
  from '@/features/student/activities/views/ActivityView/components/overlays/FinishDeclaredActivityConfirmModal/FinishDeclaredActivityConfirmModal.vue'
...
<template>
  ...
  >
    <AvButton
      ...
      :label="t('student.activities.views.ActivityView.FinishDeclaredActivity.finishButton')"
      variant="FLAT"
    ...
    >
      <AvBadge
        :label="t('student.activities.views.ActivityView.FinishDeclaredActivity.finishLabel')"
