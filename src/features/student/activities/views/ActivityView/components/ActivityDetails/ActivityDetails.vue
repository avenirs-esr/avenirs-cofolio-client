...
import FeedbackInfoCard from '@/features/student/activities/views/ActivityView/components/cards/FeedbackInfoCard/FeedbackInfoCard.vue'
...
const { declaredActivityDetails } = defineProps<ActivityDetailsProps>()
const { t } = useI18n()
  ...
  >
    ...
    >
      <div class="av-row--md av-justify-between--md av-gap-xl">
        ...
        <div class="av-col av-gap-sm av-flex-fill">
          <span class="n4">
            {{ t('student.activities.views.ActivityView.ActivityDetails.recommendedCompletionContexts') }}
          </span>
    ...
    <AvIconText
      :text="t('student.activities.views.ActivityView.ActivityDetails.modalities.title')"
      typography-class="n5"
      icon-color="var(--icon)"
    ...
    <div class="av-col av-gap-sm">
      ...
      <TraceAssociationLimitCard
        ...
        :icon="ICONS.TRACES"
        :title="t('student.activities.views.ActivityView.ActivityDetails.modalities.traceAssociationTitle')"
      />
    </div>
  </div>
</template>
