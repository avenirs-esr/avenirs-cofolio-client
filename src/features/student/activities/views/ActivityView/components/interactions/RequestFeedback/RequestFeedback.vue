...
const requestFeedbackConfig = computed(() => ({
  label: hasExistingFeedbackRequest.value
    ? t('student.activities.views.ActivityView.RequestFeedback.requestFeedbackButton.updateFeedbackLabel', { date: feedbackCreatedAt ? formatDateLocalized(feedbackCreatedAt, locale.value as AvLocale) : '' })
    : t('student.activities.views.ActivityView.RequestFeedback.requestFeedbackButton.requestFeedbackLabel'),
...
const feedbackDescription = computed(() => {
  if (remainingFeedbacks === -1) {
    return t('student.activities.views.ActivityView.RequestFeedback.requestFeedbackConfirmModal.descriptionUnlimited')
  }
  return t(
    'student.activities.views.ActivityView.RequestFeedback.requestFeedbackConfirmModal.description',
...
<template>
  ...
  <ConfirmationModal
    ...
    :title="t('student.activities.views.ActivityView.RequestFeedback.requestFeedbackConfirmModal.title')"
