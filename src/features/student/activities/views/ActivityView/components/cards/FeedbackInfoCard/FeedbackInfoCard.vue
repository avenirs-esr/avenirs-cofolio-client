...
const translationKey = 'student.activities.views.ActivityView.FeedbackInfoCard'
  ...
  >
    <template #title>
      <AvIconText
        ...
        :text="t('student.activities.views.ActivityView.FeedbackInfoCard.title')"
    ...
    >
      <AvIconText
        ...
        :text="t('student.activities.views.ActivityView.FeedbackInfoCard.description')"
