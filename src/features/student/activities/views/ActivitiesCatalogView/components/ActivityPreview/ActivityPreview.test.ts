...
import ActivityPreview, { type ActivityPreviewProps } from '@/features/student/activities/views/ActivitiesCatalogView/components/ActivityPreview/ActivityPreview.vue'
