  ...
  >
    <template #title>
      <AvIconText
        ...
        :text="t('student.activities.views.ActivitiesView.NewActivitiesPaginatorCard.title', { count: pageInfo?.totalElements ?? 0 })"
    ...
    >
      ...
      <div class="av-col av-gap-sm">
        <div class="av-row av-justify-end">
          <AvPagination
            v-if="pageInfo"
            :aria-label="t('student.activities.views.ActivitiesView.NewActivitiesPaginatorCard.pagination.ariaLabel')"
