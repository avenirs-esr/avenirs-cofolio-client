...
import ActivitiesSelector, { type ActivitiesSelectorProps } from '@/features/student/activities/views/ActivitiesView/components/overlays/ActivitiesSelector/ActivitiesSelector.vue'
