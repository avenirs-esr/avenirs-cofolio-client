  ...
  mutateSubscribeActivity(
    ...
    },
    {
      onSuccess: async () => {
        ...
        addSuccessMessage(t('student.activities.modals.SubscribeActivityConfirmModal.success'))
        emit('subscribed')
      },
      onError: (error: BaseApiException) => {
        addErrorMessage({
          title: t('student.activities.modals.SubscribeActivityConfirmModal.error'),
  ...
  >
    <template #header>
      ...
      >
        ...
        >
          {{ t('student.activities.modals.SubscribeActivityConfirmModal.title', { title: activity.title }) }}
        </span>
      </div>
    </template>
