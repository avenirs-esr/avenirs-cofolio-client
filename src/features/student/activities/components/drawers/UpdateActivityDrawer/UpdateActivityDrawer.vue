...
import ActivityPeriodFormField
  from '@/features/student/activities/components/interactions/formFields/ActivityPeriodFormField/ActivityPeriodFormField.vue'
...
const { form, isFormValid, isSubmitting } = useUpdateActivityForm(
  ...
  () => {
    addSuccessMessage({
      timeout: 2000,
      description: t('student.activities.drawers.UpdateActivityDrawer.success')
    })
    form.reset()
    emit('close')
  }
...
<template>
    ...
    <div class="av-col av-gap-md">
      ...
      >
        <AvAccordionsGroup :active-accordion="0">
          <AvAccordion
            :title="t('student.activities.drawers.UpdateActivityDrawer.sections.valorization')"
          ...
          >
            <div class="av-flex-col-md">
              <ActivityPeriodFormField
                :form="form"
                :label="t('student.activities.drawers.UpdateActivityDrawer.sections.periodLabel')"
  ...
  <ConfirmationModal
    ...
    :description="t('student.activities.drawers.UpdateActivityDrawer.confirmationModal.description')"
    @close="cancel"
    @confirm="confirm"
  />
</template>
