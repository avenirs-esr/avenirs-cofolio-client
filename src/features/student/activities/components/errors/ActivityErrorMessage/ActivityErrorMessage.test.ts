...
import ActivityErrorMessage, { type ActivityErrorMessageProps } from '@/features/student/activities/components/errors/ActivityErrorMessage/ActivityErrorMessage.vue'
