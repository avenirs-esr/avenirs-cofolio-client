...
vi.mock('@/features/student/buildProject/views/BuildProjectView/sections/BuildProjectSection/composables/use-mind-map-flow/use-mind-map-flow', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@/features/student/buildProject/views/BuildProjectView/sections/BuildProjectSection/composables/use-mind-map-flow/use-mind-map-flow')>()
  return {
    ...actual,
    useMindMapFlow: () => ({
