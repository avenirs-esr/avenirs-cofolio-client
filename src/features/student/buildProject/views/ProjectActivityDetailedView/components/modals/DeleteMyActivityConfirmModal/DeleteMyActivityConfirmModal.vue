...
const { mutate: deleteActivity, isPending } = useDeleteActivity({
  mutation: {
    onSuccess: async () => {
      ...
      addSuccessMessage(t('student.declaredSkills.overlays.modals.DeleteMyActivityConfirmModal.success'))
      emit('deleted')
    },
...
<template>
  <ConfirmationModal
    ...
    title=""
    :description="t('student.declaredSkills.overlays.modals.DeleteMyActivityConfirmModal.title', { activityTitle })"
