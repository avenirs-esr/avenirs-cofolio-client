...
import AdditionalSkillLevelRadioButtonSet from '@/features/student/components/additionalSkills/interactions/radios/AdditionalSkillLevelRadioButtonSet/AdditionalSkillLevelRadioButtonSet.vue'
...
BddTest().given('a skill level field component', () => {
  ...
  beforeEach(async () => {
    ...
    wrapper = mountComponent(AdditionalSkillLevelRadioButtonSet, {
      props: {
  ...
  BddTest().when('a skill level is selected', () => {
    BddTest().then('it should accept valid enum value BEGINNER', async () => {
      await wrapper.setProps({ modelValue: EAdditionalSkillLevel.BEGINNER })
    ...
    BddTest().then('it should accept valid enum value EXPERT', async () => {
      await wrapper.setProps({ modelValue: EAdditionalSkillLevel.EXPERT })
      await wrapper.vm.$nextTick()
  ...
  BddTest().when('integrating with v-model', () => {
    BddTest().then('it should render with v-model value', async () => {
      await wrapper.setProps({ modelValue: EAdditionalSkillLevel.ADVANCED })
      await wrapper.vm.$nextTick()
