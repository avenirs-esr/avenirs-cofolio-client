...
import TraceAiUsageToggleFormField from '@/features/student/components/traces/interactions/formFields/TraceAiUsageToggleFormField/TraceAiUsageToggleFormField.vue'
...
BddTest().given('a trace AI usage toggle form field component', () => {
  ...
  BddTest().when('the component is mounted', () => {
    ...
    BddTest().then('it should have the correct id', () => {
      const toggle = wrapper.findComponent({ name: 'TraceAiUsageToggle' })
      expect(toggle.props('id')).toBe('use-ia')
    })
