...
describe('useAdditionalSkillForm', () => {
  describe('given the useAdditionalSkillForm composable', () => {
    ...
    describe('when form is validated with invalid data', () => {
      ...
      it('then it should return validation errors for missing level', () => {
      ...
      it('then it should return validation errors when both fields are missing', () => {
        const invalidData = createInvalidFormData()
        const validator = getOnSubmitValidator()
        const validationResult = validator({ value: invalidData })
      ...
      it('then it should handle empty selectedSkills array', () => {
        const invalidData: AdditionalSkillFormData = {
          selectedSkills: [],
    ...
    describe('when form is validated with valid data', () => {
      ...
      it('then it should validate with different skill types', () => {
      ...
      it('then it should validate with all skill levels', () => {
        const skillLevels = [
    ...
    describe('when form is submitted', () => {
      ...
      it('then it should trigger the mutation on form submit', async () => {
        const validData = createValidFormData()
      ...
      it('then it should call createAdditionalSkillProgress API with correct parameters', async () => {
      ...
      it('then it should call createAdditionalSkillProgress API with different skill levels', async () => {
      ...
      it('then it should handle different skill types in API call', async () => {
      ...
      it('then it should call onSubmit callback after successful API call', async () => {
        const validData = createValidFormData()
        const handler = getOnSubmitHandler()
    ...
    describe('when form validity is determined', () => {
      it('then it should return true initially when form is valid', () => {
        expect(composableResult.isFormValid.value).toBe(true)
      })

      it('then it should return false when form has validation errors', () => {
        expect(composableResult.isFormValid.value).toBeDefined()
        expect(typeof composableResult.isFormValid.value).toBe('boolean')
      })

      it('then it should be reactive to form state changes', () => {
        expect(composableResult.isFormValid).toBeDefined()
        expect(composableResult.isFormValid.value).toBe(true)
      })
    })

    describe('when form state is managed', () => {
      it('then it should have proper default values', () => {
      ...
      it('then it should track form validation state', () => {
        const state = composableResult.form.useStore(state => state)
      ...
      it('then it should provide isSubmitting state', () => {
    ...
    describe('when API errors occur', () => {
      ...
      it('then it should not call onSubmit when API fails', async () => {
        const validData = createValidFormData()
        const handler = getOnSubmitHandler()
    ...
    describe('when form data is transformed to DTO', () => {
      it('then it should correctly transform form data to DTO', async () => {
      ...
      it('then it should handle multiple skills by taking the first one', async () => {
