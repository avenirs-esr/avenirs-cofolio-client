...
import { useUpdateProfile, useUpdateProfileCover, useUpdateProfilePhoto } from '@/features/student/views/StudentHomeView/components/UpdateProfileDrawer/use-update-profile'
import { useUpdateProfileForm } from '@/features/student/views/StudentHomeView/components/UpdateProfileDrawer/use-update-profile-form'
...
vi.mock('./use-update-profile', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@/features/student/views/StudentHomeView/components/UpdateProfileDrawer/use-update-profile')>()
