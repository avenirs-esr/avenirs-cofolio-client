...
describe('studentProjectTrajectoriesContainer', () => {
  describe('given a project trajectories container component', () => {
    ...
    describe('when the component is mounted', () => {
      ...
      it('then it should display the build project section by default', () => {
    ...
    describe('when different menu items are selected', () => {
      it('then it should display trajectories section when TRAJECTORIES is selected', async () => {
        const sideNavigation = wrapper.findComponent({ name: 'AvSideNavigation' })
      ...
      it('then it should display self knowledge section when SELF_KNOWLEDGE is selected', async () => {
        const sideNavigation = wrapper.findComponent({ name: 'AvSideNavigation' })
      ...
      it('then it should display explore futures section when EXPLORE_FUTURES is selected', async () => {
        const sideNavigation = wrapper.findComponent({ name: 'AvSideNavigation' })
      ...
      it('then it should display build project section when BUILD_PROJECT is selected', async () => {
        const sideNavigation = wrapper.findComponent({ name: 'AvSideNavigation' })
