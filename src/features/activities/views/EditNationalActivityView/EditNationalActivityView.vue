...
import AddNationalActivitySideNavigation from '@/features/activities/components/navigation/AddNationalActivitySideNavigation/AddNationalActivitySideNavigation.vue'
...
import { ACTIVITY_AUTO_SAVE_DEBOUNCE, ACTIVITY_TRACE_SETTING_INFINITY_VALUE } from '@/features/activities/config'
import { EditActivityTabIndex } from '@/features/activities/editActivity.constants'
import { type EditActivityFormData, EditActivityFormDataBannerAction } from '@/features/activities/types/forms.types'
...
import { provideEditNationalActivityViewContext } from '@/features/activities/views/EditNationalActivityView/EditNationalActivityViewContext'
