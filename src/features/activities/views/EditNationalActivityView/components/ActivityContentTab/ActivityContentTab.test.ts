...
import { ActivityConsignFormFieldStub } from '@/features/activities/components/interactions/formFields/ActivityConsignFormField/ActivityConsignFormField.stub'
import { ActivityExecutionPeriodFormFieldStub } from '@/features/activities/components/interactions/formFields/ActivityExecutionPeriodFormField/ActivityExecutionPeriodFormField.stub'
import { ActivityFeedbackFormFieldStub } from '@/features/activities/components/interactions/formFields/ActivityFeedbackFormField/ActivityFeedbackFormField.stub'
import { ActivityReflectionFormFieldStub } from '@/features/activities/components/interactions/formFields/ActivityReflectionFormField/ActivityReflectionFormField.stub'
import { ActivityTitleFormFieldStub } from '@/features/activities/components/interactions/formFields/ActivityTitleFormField/ActivityTitleFormField.stub'
import { ActivityTraceFormFieldStub } from '@/features/activities/components/interactions/formFields/ActivityTraceFormField/ActivityTraceFormField.stub'
import { ActivityResourcesListEditableStub } from '@/features/activities/components/lists/ActivityResourcesListEditable/ActivityResourcesListEditable.stub'
import { ContentSectionId } from '@/features/activities/editActivity.constants'
import { ActivityResourceType } from '@/features/activities/types/resource.types'
import ActivityContentTab from '@/features/activities/views/EditNationalActivityView/components/ActivityContentTab/ActivityContentTab.vue'
import { EditNationalActivityViewTabActionsStub } from '@/features/activities/views/EditNationalActivityView/components/EditNationalActivityViewTabActions/EditNationalActivityViewTabActions.stub'
import { EditNationalActivityViewFormWrapper, EditNationalActivityViewFormWrapperDirty } from '@/features/activities/views/EditNationalActivityView/EditNationalActivityView.stub'
