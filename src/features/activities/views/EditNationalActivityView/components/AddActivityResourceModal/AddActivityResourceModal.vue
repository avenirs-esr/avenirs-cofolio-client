...
import AddActivityResourceFileUploadFormField from '@/features/activities/views/EditNationalActivityView/components/AddActivityResourceModal/components/AddActivityResourceFileUploadFormField/AddActivityResourceFileUploadFormField.vue'
import AddActivityResourceLinkInputFormField from '@/features/activities/views/EditNationalActivityView/components/AddActivityResourceModal/components/AddActivityResourceLinkInputFormField/AddActivityResourceLinkInputFormField.vue'
...
import AddActivityResourceTypeSelectFormField from '@/features/activities/views/EditNationalActivityView/components/AddActivityResourceModal/components/AddActivityResourceTypeSelectFormField/AddActivityResourceTypeSelectFormField.vue'
