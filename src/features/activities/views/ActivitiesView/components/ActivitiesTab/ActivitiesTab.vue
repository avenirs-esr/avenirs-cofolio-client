...
import DeleteDraftActivityConfirmationModal from '@/features/activities/components/modals/DeleteDraftActivityConfirmationModal/DeleteDraftActivityConfirmationModal.vue'
import UnpublishActivityConfirmationModal from '@/features/activities/components/modals/UnpublishActivityConfirmationModal/UnpublishActivityConfirmationModal.vue'
import { usePaginatedStaffActivities, type UsePaginatedStaffActivitiesParams } from '@/features/activities/composables/use-paginated-staff-activites/use-paginated-staff-activites'
import { mapActivityToActivityTableRow } from '@/features/activities/views/ActivitiesView/ActivitiesView.utils'
import ActivityCard from '@/features/activities/views/ActivitiesView/components/ActivityCard/ActivityCard.vue'
import ActivityTableTitle from '@/features/activities/views/ActivitiesView/components/ActivityTableTitle/ActivityTableTitle.vue'
import MoreActionsDropdown from '@/features/activities/views/ActivitiesView/components/MoreActionsDropdown/MoreActionsDropdown.vue'
