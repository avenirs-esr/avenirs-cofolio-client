...
import NationalActivityCatalogPreviewTab from '@/features/activities/views/NationalActivityCatalogView/components/NationalActivityCatalogPreviewTab/NationalActivityCatalogPreviewTab.vue'
