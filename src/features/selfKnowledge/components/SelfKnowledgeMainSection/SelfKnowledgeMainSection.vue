...
import AddSelfKnowledgeCategoriesModal from '@/features/selfKnowledge/components/modals/AddSelfKnowledgeCategoriesModal/AddSelfKnowledgeCategoriesModal.vue'
import AddSelfKnowledgeCategoryElementDrawer
  from '@/features/selfKnowledge/components/overlays/AddSelfKnowledgeCategoryElementDrawer/AddSelfKnowledgeCategoryElementDrawer.vue'
