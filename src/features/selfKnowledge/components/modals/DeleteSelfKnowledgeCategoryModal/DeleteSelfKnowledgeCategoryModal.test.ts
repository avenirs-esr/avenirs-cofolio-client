...
import DeleteSelfKnowledgeCategoryModal, { type DeleteSelfKnowledgeCategoryModalProps } from '@/features/selfKnowledge/components/modals/DeleteSelfKnowledgeCategoryModal/DeleteSelfKnowledgeCategoryModal.vue'
...
BddTest().given('the DeleteSelfKnowledgeCategoryModal component', () => {
  ...
  BddTest().when('the component is mounted with many elements', () => {
    ...
    BddTest().then('it should render the description with elements count in plural', () => {
      const description = wrapper.find('[data-testid="delete-self-knowledge-category-modal__body"]')
