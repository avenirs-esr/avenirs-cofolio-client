...
import SelfKnowledgeCategoryElementsPaginatorCard from '@/features/selfKnowledge/components/cards/SelfKnowledgeCategoryElementsPaginatorCard/SelfKnowledgeCategoryElementsPaginatorCard.vue'
import { SelfKnowledgeElementCardStub } from '@/features/selfKnowledge/components/cards/SelfKnowledgeElementCard/SelfKnowledgeElementCard.stub'
import { SelfKnowledgeElementsDropdownStub } from '@/features/selfKnowledge/components/dropdowns/SelfKnowledgeElementsDropdown/SelfKnowledgeElementsDropdown.stub'
import { DeleteSelfKnowledgeCategoryModalStub } from '@/features/selfKnowledge/components/modals/DeleteSelfKnowledgeCategoryModal/DeleteSelfKnowledgeCategoryModal.stub'
import { DeleteSelfKnowledgeElementsModalStub } from '@/features/selfKnowledge/components/modals/DeleteSelfKnowledgeElementsModal/DeleteSelfKnowledgeElementsModal.stub'
...
vi.mock('@/features/selfKnowledge/stores/self-knowledge.store', () => ({
