import { AllActivitiesHeaderCardStub } from '@/features/buildProject/views/ProjectActivitiesView/components/AllActivitiesHeaderCard/AllActivitiesHeaderCard.stub'
import { AllActivitiesSectionStub } from '@/features/buildProject/views/ProjectActivitiesView/components/AllActivitiesSection/AllActivitiesSection.stub'
import AllActivitiesTab from '@/features/buildProject/views/ProjectActivitiesView/components/AllActivitiesTab/AllActivitiesTab.vue'
import { NewActivitiesPaginatorCardStub } from '@/features/buildProject/views/ProjectActivitiesView/components/NewActivitiesPaginatorCard/NewActivitiesPaginatorCard.stub'
