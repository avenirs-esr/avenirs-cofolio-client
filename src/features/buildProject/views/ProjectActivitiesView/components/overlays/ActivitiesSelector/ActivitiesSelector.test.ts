...
import ActivitiesSelector, { type ActivitiesSelectorProps } from '@/features/buildProject/views/ProjectActivitiesView/components/overlays/ActivitiesSelector/ActivitiesSelector.vue'
