...
import { UnsubscribeActivitiesConfirmModalStub } from '@/features/buildProject/components/modals/UnsubscribeActivitiesConfirmModal/UnsubscribeActivitiesConfirmModal.stub'
import { ProjectActivitiesTab } from '@/features/buildProject/types/activities.types'
import { ActivityDetailedDropdownStub } from '@/features/buildProject/views/ProjectActivityDetailedView/components/overlays/ActivityDetailedDropdown/ActivityDetailedDropdown.stub'
import {
  ProjectActivityDetailedLayoutStub
} from '@/features/buildProject/views/ProjectActivityDetailedView/components/ProjectActivityDetailedLayout/ProjectActivityDetailedLayout.stub'
import ProjectActivityDetailedView, { type ProjectActivityDetailedViewProps } from '@/features/buildProject/views/ProjectActivityDetailedView/ProjectActivityDetailedView.vue'
