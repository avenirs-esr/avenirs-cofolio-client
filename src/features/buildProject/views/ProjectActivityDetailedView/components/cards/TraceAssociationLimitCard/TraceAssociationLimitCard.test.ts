import type { TraceAssociationLimitCardProps } from '@/features/buildProject/views/ProjectActivityDetailedView/components/cards/TraceAssociationLimitCard/TraceAssociationLimitCard.vue'
import type { VueWrapper } from '@vue/test-utils'
import { WarningBadgeStub } from '@/common/components/badges/WarningBadge/WarningBadge.stub'
import { CardStub } from '@/common/components/cards/Card/Card.stub'
import TraceAssociationLimitCard from '@/features/buildProject/views/ProjectActivityDetailedView/components/cards/TraceAssociationLimitCard/TraceAssociationLimitCard.vue'
