...
import TraceAssociationLimitCard
  from '@/features/buildProject/views/ProjectActivityDetailedView/components/cards/TraceAssociationLimitCard/TraceAssociationLimitCard.vue'
import AssociateDeclaredSkillToActivityModal
  from '@/features/buildProject/views/ProjectActivityDetailedView/components/modals/AssociateDeclaredSkillToActivityModal/AssociateDeclaredSkillToActivityModal.vue'
import AssociateTracesToDeclaredActivity
  from '@/features/buildProject/views/ProjectActivityDetailedView/components/overlays/modals/AssociateTracesModal/AssociateTracesToDeclaredActivity.vue'
import DeleteActivityAssociatedElementsModal
  from '@/features/buildProject/views/ProjectActivityDetailedView/components/overlays/modals/DeleteActivityAssociatedElementsModal/DeleteActivityAssociatedElementsModal.vue'
import { AssociatedDeclaredSkillsCard } from '@/features/declaredSkills'
