...
import { TraceAssociationLimitCardStub }
  from '@/features/buildProject/views/ProjectActivityDetailedView/components/cards/TraceAssociationLimitCard/TraceAssociationLimitCard.stub'
import {
  AssociateDeclaredSkillsToActivityModalStub
} from '@/features/buildProject/views/ProjectActivityDetailedView/components/modals/AssociateDeclaredSkillToActivityModal/AssociateDeclaredSkillToActivityModal.stub'
import {
  AssociateTracesToDeclaredActivityStub
} from '@/features/buildProject/views/ProjectActivityDetailedView/components/overlays/modals/AssociateTracesModal/AssociateTracesToDeclaredActivity.stub'
import { DeleteActivityAssociatedElementsModalStub } from '@/features/buildProject/views/ProjectActivityDetailedView/components/overlays/modals/DeleteActivityAssociatedElementsModal/DeleteActivityAssociatedElementsModal.stub'
import AssociatedElementsTab, { type AssociatedElementsTabProps } from '@/features/buildProject/views/ProjectActivityDetailedView/components/tabs/AssociatedElementsTab/AssociatedElementsTab.vue'
import {
  AssociatedDeclaredSkillsCardStub
} from '@/features/declaredSkills/components/cards/AssociatedDeclaredSkillsCard/AssociatedDeclaredSkillsCard.stub'
