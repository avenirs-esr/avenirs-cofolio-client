...
import { MyPerspectiveCardStub } from '@/features/buildProject/views/ProjectActivityDetailedView/components/cards/MyPerspectiveCard/MyPerspectiveCard.stub'
import { PerspectiveTabActionsStub } from '@/features/buildProject/views/ProjectActivityDetailedView/components/interactions/PerspectiveTabActions/PerspectiveTabActions.stub'
import { ReceivedFeedbacksSectionStub } from '@/features/buildProject/views/ProjectActivityDetailedView/components/sections/ReceivedFeedbacksSection/ReceivedFeedbacksSection.stub'
import MyPerspectiveTab, {
  type MyPerspectiveTabProps,
} from '@/features/buildProject/views/ProjectActivityDetailedView/components/tabs/MyPerspectiveTab/MyPerspectiveTab.vue'
