...
import SubscribeActivityConfirmModal, { type SubscribeActivityConfirmModalProps } from '@/features/buildProject/components/modals/SubscribeActivityConfirmModal/SubscribeActivityConfirmModal.vue'
