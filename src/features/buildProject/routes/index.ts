...
export const projectActivitiesRoute: AvRoute = {
  ...
  component: () => import('@/features/buildProject/views/ProjectActivitiesView/ProjectActivitiesView.vue'),
}
...
export const projectActivitiesDetailedRoute: AvRoute = {
  ...
  component: () =>
    import('@/features/buildProject/views/ProjectActivityDetailedView/ProjectActivityDetailedView.vue'),
}
...
export const projectActivitiesCatalogRoute: AvRoute = {
  ...
  component: () =>
    import('@/features/buildProject/views/ProjectActivitiesCatalogView/ProjectActivitiesCatalogView.vue'),
}

export const projectTrajectoriesRoute: AvRoute = {
  ...ROUTES.STUDENT.PROJECT_TRAJECTORIES,
  component: () => import('@/features/global/views/StudentProjectTrajectoriesView/StudentProjectTrajectoriesView.vue'),
}
