...
import DeleteDeclaredProgramConfirmModal, { type DeleteDeclaredProgramConfirmModalProps } from '@/features/personalCareer/components/overlays/DeleteDeclaredProgramConfirmModal/DeleteDeclaredProgramConfirmModal.vue'
