...
import DeleteDeclaredExperienceConfirmModal, { type DeleteDeclaredExperienceConfirmModalProps } from '@/features/personalCareer/components/overlays/DeleteDeclaredExperienceConfirmModal/DeleteDeclaredExperienceConfirmModal.vue'
