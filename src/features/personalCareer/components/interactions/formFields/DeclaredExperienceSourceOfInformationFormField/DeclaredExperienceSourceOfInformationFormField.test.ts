...
import { DeclaredExperienceSourceOfInformationInputStub } from '@/features/personalCareer/components/interactions/inputs/DeclaredExperienceSourceOfInformationInput/DeclaredExperienceSourceOfInformationInput.stub'
import {
...
const TestWrapper = createFormFieldTestWrapper<DeclaredExperienceFormData, 'sourceOfInformation'>({
