...
import { DeclaredExperienceDescriptionTextareaStub } from '@/features/personalCareer/components/interactions/inputs/DeclaredExperienceDescriptionTextarea/DeclaredExperienceDescriptionTextarea.stub'
import {
...
import { DECLARED_EXPERIENCE_DESCRIPTION_MAX_LENGTH } from '@/features/personalCareer/config'
import { BddTest } from '@avenirs-esr/avenirs-dsav/test-utils'
import { mount, type VueWrapper } from '@vue/test-utils'
import { createFormFieldTestWrapper } from 'tests/utils'
import { beforeEach, expect, vi } from 'vitest'

const TestWrapper = createFormFieldTestWrapper<DeclaredExperienceFormData, 'description'>({
