...
import DeclaredExperienceUpdateView, { type DeclaredExperienceUpdateViewProps } from '@/features/personalCareer/views/DeclaredExperienceUpdateView/DeclaredExperienceUpdateView.vue'
