...
import { KitValorizationToggleFormFieldStub } from '@/features/global/components/interaction/formFields/KitValorizationToggleFormField/KitValorizationToggleFormField.stub'
import { DeclaredExperienceActivitySectorFormFieldStub } from '@/features/personalCareer/components/interactions/formFields/DeclaredExperienceActivitySectorFormField/DeclaredExperienceActivitySectorFormField.stub'
import { DeclaredExperienceDescriptionFormFieldStub } from '@/features/personalCareer/components/interactions/formFields/DeclaredExperienceDescriptionFormField/DeclaredExperienceDescriptionFormField.stub'
import { DeclaredExperienceExternalLinkFormFieldStub } from '@/features/personalCareer/components/interactions/formFields/DeclaredExperienceExternalLinkFormField/DeclaredExperienceExternalLinkFormField.stub'
import { DeclaredExperienceLocationFormFieldStub } from '@/features/personalCareer/components/interactions/formFields/DeclaredExperienceLocationFormField/DeclaredExperienceLocationFormField.stub'
import { DeclaredExperienceOrganizationFormFieldStub } from '@/features/personalCareer/components/interactions/formFields/DeclaredExperienceOrganizationFormField/DeclaredExperienceOrganizationFormField.stub'
import { DeclaredExperiencePeriodFormFieldStub } from '@/features/personalCareer/components/interactions/formFields/DeclaredExperiencePeriodFormField/DeclaredExperiencePeriodFormField.stub'
import { DeclaredExperienceSourceOfInformationFormFieldStub } from '@/features/personalCareer/components/interactions/formFields/DeclaredExperienceSourceOfInformationFormField/DeclaredExperienceSourceOfInformationFormField.stub'
import { DeclaredExperienceSummaryFormFieldStub } from '@/features/personalCareer/components/interactions/formFields/DeclaredExperienceSummaryFormField/DeclaredExperienceSummaryFormField.stub'
import { DeclaredExperienceTitleFormFieldStub } from '@/features/personalCareer/components/interactions/formFields/DeclaredExperienceTitleFormField/DeclaredExperienceTitleFormField.stub'
import { DeclaredExperienceTypeFormFieldStub } from '@/features/personalCareer/components/interactions/formFields/DeclaredExperienceTypeFormField/DeclaredExperienceTypeFormField.stub'
import UpdateDeclaredExperienceForm from '@/features/personalCareer/views/DeclaredExperienceUpdateView/components/UpdateDeclaredExperienceForm/UpdateDeclaredExperienceForm.vue'
...
vi.mock(
  '@/features/personalCareer/views/DeclaredExperienceUpdateView/components/UpdateDeclaredExperienceForm/use-update-declared-experience-form/use-update-declared-experience-form',
  () => ({
