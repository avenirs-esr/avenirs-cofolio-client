...
import DeclaredProgramOrganizationInput from '@/features/personalCareer/components/interactions/inputs/DeclaredProgramOrganizationInput/DeclaredProgramOrganizationInput.vue'
...
import DeclaredProgramTitleInput from '@/features/personalCareer/components/interactions/inputs/DeclaredProgramTitleInput/DeclaredProgramTitleInput.vue'
import DeclaredProgramDetailed, { type DeclaredProgramDetailedProps } from '@/features/personalCareer/views/DeclaredProgramDetailedView/components/DeclaredProgramDetailed/DeclaredProgramDetailed.vue'
