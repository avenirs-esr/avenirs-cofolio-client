...
import AddDeclaredExperienceDrawer
  from '@/features/personalCareer/components/overlays/AddDeclaredExperienceDrawer/AddDeclaredExperienceDrawer.vue'
...
import DeclaredExperiencesMoreActionsDropdown
  from '@/features/personalCareer/views/PersonalCareerView/sections/ExperiencesSection/components/DeclaredExperiencesMoreActionsDropdown/DeclaredExperiencesMoreActionsDropdown.vue'
