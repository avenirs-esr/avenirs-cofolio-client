...
import DeclaredExperienceSelector, { type DeclaredExperienceSelectorProps } from '@/features/personalCareer/views/PersonalCareerView/sections/ExperiencesSection/components/DeclaredExperienceSelector/DeclaredExperienceSelector.vue'
