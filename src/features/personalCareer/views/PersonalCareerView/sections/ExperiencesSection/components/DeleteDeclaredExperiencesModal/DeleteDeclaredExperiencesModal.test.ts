...
import { DeleteDeclaredExperienceConfirmModalStub } from '@/features/personalCareer/components/overlays/DeleteDeclaredExperienceConfirmModal/DeleteDeclaredExperienceConfirmModal.stub'
import { DeclaredExperienceSelectorStub } from '@/features/personalCareer/views/PersonalCareerView/sections/ExperiencesSection/components/DeclaredExperienceSelector/DeclaredExperienceSelector.stub'
import DeleteDeclaredExperiencesModal from '@/features/personalCareer/views/PersonalCareerView/sections/ExperiencesSection/components/DeleteDeclaredExperiencesModal/DeleteDeclaredExperiencesModal.vue'
