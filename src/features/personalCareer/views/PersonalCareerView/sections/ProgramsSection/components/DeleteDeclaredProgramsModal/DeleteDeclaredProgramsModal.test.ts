...
import { DeclaredProgramSelectorStub } from '@/features/personalCareer/views/PersonalCareerView/sections/ProgramsSection/components/DeclaredProgramSelector/DeclaredProgramSelector.stub'
