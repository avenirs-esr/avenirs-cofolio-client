import DeclaredProgramsMoreActionsDropdown from '@/features/personalCareer/views/PersonalCareerView/sections/ProgramsSection/components/DeclaredProgramsMoreActionsDropdown/DeclaredProgramsMoreActionsDropdown.vue'
...
BddTest().given('a declared programs more actions dropdown', () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks()
    wrapper = mount(DeclaredProgramsMoreActionsDropdown, {
      global: { stubs }
    })
  })
  ...
  BddTest().when('the component is mounted', () => {
    ...
    BddTest().and('the dropdown props are validated', () => {
      ...
      BddTest().then('it should have add item with correct properties', () => {
        ...
        expect(addItem?.label).toBe('Ajouter une formation')
      })
      ...
      BddTest().then('it should have share item with correct properties', () => {
        ...
        expect(shareItem?.label).toBe('Partager une formation')
      })
      ...
      BddTest().then('it should have delete item with correct properties', () => {
        ...
        expect(deleteItem?.label).toBe('Supprimer une formation')
      })
    })
  })
