...
import { AssociatedTracesCardStub }
  from '@/features/buildProject/views/ProjectActivityDetailedView/components/cards/AssociatedTracesCard/AssociatedTracesCard.stub'
...
import DeclaredExperienceAssociations
  from '@/features/personalCareer/views/DeclaredExperienceView/components/DeclaredExperienceAssociations/DeclaredExperienceAssociations.vue'
import { AssociateDeclaredSkillsToDeclaredExperienceModalStub }
  from '@/features/personalCareer/views/DeclaredExperienceView/components/overlays/modals/AssociateDeclaredSkillsToDeclaredExperienceModal/AssociateDeclaredSkillsToDeclaredExperienceModal.stub'
import { AssociateTracesToDeclaredExperienceModalStub }
  from '@/features/personalCareer/views/DeclaredExperienceView/components/overlays/modals/AssociateTracesToDeclaredExperienceModal/AssociateTracesToDeclaredExperienceModal.stub'
import { DeleteDeclaredExperienceAssociatedDeclaredSkillsModalStub }
  from '@/features/personalCareer/views/DeclaredExperienceView/components/overlays/modals/DeleteDeclaredExperienceAssociatedDeclaredSkillsModal/DeleteDeclaredExperienceAssociatedDeclaredSkillsModal.stub'
import { DeleteDeclaredExperienceAssociatedTracesModalStub }
  from '@/features/personalCareer/views/DeclaredExperienceView/components/overlays/modals/DeleteDeclaredExperienceAssociatedTracesModal/DeleteDeclaredExperienceAssociatedTracesModal.stub'
