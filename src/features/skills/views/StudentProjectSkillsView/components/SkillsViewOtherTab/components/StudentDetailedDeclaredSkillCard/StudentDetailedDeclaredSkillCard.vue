...
import { DeclaredSkillMacroSkillBadge } from '@/features/declaredSkills'
import StudentDetailedSkillCard from '@/features/skills/components/cards/StudentDetailedSkillCard/StudentDetailedSkillCard.vue'
