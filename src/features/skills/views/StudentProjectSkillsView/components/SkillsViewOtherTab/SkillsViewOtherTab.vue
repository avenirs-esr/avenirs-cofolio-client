...
import { AddDeclaredSkillDrawer, useDeclaredSkillsStore } from '@/features/declaredSkills'
import StudentDetailedDeclaredSkillCard from '@/features/skills/views/StudentProjectSkillsView/components/SkillsViewOtherTab/components/StudentDetailedDeclaredSkillCard/StudentDetailedDeclaredSkillCard.vue'
