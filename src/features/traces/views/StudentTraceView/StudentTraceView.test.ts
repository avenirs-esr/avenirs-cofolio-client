...
import { TraceAssociationsStub } from '@/features/traces/components/composites/TraceAssociations/TraceAssociations.stub'
import {
  TraceDeletionConfirmationModalStub
} from '@/features/traces/components/modals/TraceDeletionConfirmationModal/TraceDeletionConfirmationModal.stub'
import {
  StudentTraceDetailsStub
} from '@/features/traces/views/StudentToolsTracesView/components/StudentTraceDetails/StudentTraceDetails.stub'
...
} from '@/features/traces/views/StudentTraceView/components/TraceSettingsDropdown/TraceSettingsDropdown.stub'
import StudentTraceView from '@/features/traces/views/StudentTraceView/StudentTraceView.vue'
