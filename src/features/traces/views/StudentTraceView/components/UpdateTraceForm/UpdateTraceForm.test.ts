import type { UpdateTraceForm as UpdateTraceFormType } from '@/features/traces/types/forms.types'
...
import { TraceAiJustificationTextareaFormFieldStub } from '@/features/traces/components/interactions/formFields/TraceAiJustificationTextareaFormField/TraceAiJustificationTextareaFormField.stub'
import { TraceAiUsageToggleFormFieldStub } from '@/features/traces/components/interactions/formFields/TraceAiUsageToggleFormField/TraceAiUsageToggleFormField.stub'
import { TraceFileUploadFormFieldStub } from '@/features/traces/components/interactions/formFields/TraceFileUploadFormField/TraceFileUploadFormField.stub'
...
import { TraceNameInputFormFieldStub } from '@/features/traces/components/interactions/formFields/TraceNameInputFormField/TraceNameInputFormField.stub'
import { TracePersonalNoteTextareaFormFieldStub } from '@/features/traces/components/interactions/formFields/TracePersonalNoteTextareaFormField/TracePersonalNoteTextareaFormField.stub'
import { TraceAuthorTypeRadioSetFormFieldStub } from '@/features/traces/components/interactions/radios/TraceAuthorTypeRadioSetFormField/TraceAuthorTypeRadioSetFormField.stub'
import { TraceType } from '@/features/traces/types/traces.types'
import UpdateTraceForm from '@/features/traces/views/StudentTraceView/components/UpdateTraceForm/UpdateTraceForm.vue'
