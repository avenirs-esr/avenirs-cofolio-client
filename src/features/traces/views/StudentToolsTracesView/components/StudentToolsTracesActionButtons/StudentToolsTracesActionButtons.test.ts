...
import { DeleteTracesModalStub } from '@/features/traces/views/StudentToolsTracesView/components/DeleteTracesModal/DeleteTracesModal.stub'
import StudentToolsTracesActionButtons from '@/features/traces/views/StudentToolsTracesView/components/StudentToolsTracesActionButtons/StudentToolsTracesActionButtons.vue'
import { TracesActionsDropdownStub } from '@/features/traces/views/StudentToolsTracesView/components/TracesActionsDropdown/TracesActionsDropdown.stub'
