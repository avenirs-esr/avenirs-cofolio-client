...
import { TracesSelectorStub } from '@/features/traces/components/interactions/pickers/TracesSelector/TraceSelector.stub'
import {
...
import { usePaginatedTraces } from '@/features/traces/composables/use-paginated-traces/use-paginated-traces'
import DeleteTracesModal
  from '@/features/traces/views/StudentToolsTracesView/components/DeleteTracesModal/DeleteTracesModal.vue'
import { BddTest } from '@avenirs-esr/avenirs-dsav/test-utils'
import { mountComponent } from 'tests/utils'
import { beforeEach, expect, type MockedFunction, vi } from 'vitest'

vi.mock('@/features/traces/composables/use-paginated-traces/use-paginated-traces', () => ({
