...
import { UpdateTabsStub } from '@/features/traces/views/StudentUpdateTraceView/components/UpdateTabs/UpdateTabs.stub'
import StudentUpdateTraceView from '@/features/traces/views/StudentUpdateTraceView/StudentUpdateTraceView.vue'
...
vi.mock(
  '@/features/traces/views/StudentTraceView/components/UpdateTraceForm/use-update-trace-form/use-update-trace-form',
  () => ({
    useUpdateTraceForm: () => ({
      form: {},
      hasErrors: ref(false),
