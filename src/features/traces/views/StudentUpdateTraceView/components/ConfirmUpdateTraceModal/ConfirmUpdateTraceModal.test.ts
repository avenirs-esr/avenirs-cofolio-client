...
import ConfirmUpdateTraceModal, { type ConfirmUpdateTraceModalProps } from '@/features/traces/views/StudentUpdateTraceView/components/ConfirmUpdateTraceModal/ConfirmUpdateTraceModal.vue'
