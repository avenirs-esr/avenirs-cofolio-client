...
import { ValorizedDeclaredExperienceItemStub } from '@/features/kit/views/StudentToolsKitView/components/ValorizedDeclaredExperienceItem/ValorizedDeclaredExperienceItem.stub'
