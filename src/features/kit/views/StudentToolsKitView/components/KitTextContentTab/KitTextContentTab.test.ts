...
import KitTextContentTab from '@/features/kit/views/StudentToolsKitView/components/KitTextContentTab/KitTextContentTab.vue'
import { ValorizedDeclaredExperiencesContainerStub } from '@/features/kit/views/StudentToolsKitView/components/ValorizedDeclaredExperiencesContainer/ValorizedDeclaredExperiencesContainer.stub'
import { ValorizedDeclaredProgramsContainerStub } from '@/features/kit/views/StudentToolsKitView/components/ValorizedDeclaredProgramsContainer/ValorizedDeclaredProgramsContainer.stub'
import { ValorizedDeclaredSkillsContainerStub } from '@/features/kit/views/StudentToolsKitView/components/ValorizedDeclaredSkillsContainer/ValorizedDeclaredSkillsContainer.stub'
import { ValorizedSelfKnowledgeContainerStub } from '@/features/kit/views/StudentToolsKitView/components/ValorizedSelfKnowledgeContainer/ValorizedSelfKnowledgeContainer.stub'
