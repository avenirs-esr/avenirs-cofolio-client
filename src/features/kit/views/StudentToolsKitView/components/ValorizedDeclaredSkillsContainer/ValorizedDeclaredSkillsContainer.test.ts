...
import { ValorizedDeclaredSkillItemStub } from '@/features/kit/views/StudentToolsKitView/components/ValorizedDeclaredSkillItem/ValorizedDeclaredSkillItem.stub'
