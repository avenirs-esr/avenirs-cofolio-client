...
BddTest().given('a declared skill type badge component', () => {
  let wrapper: VueWrapper<InstanceType<typeof DeclaredSkillTypeBadge>>

  beforeEach(() => {
    vi.clearAllMocks()

    wrapper = mount(DeclaredSkillTypeBadge, {
      props: {
        label: 'ROME 4.0',
