import type { DeclaredSkillFormData } from '@/features/declaredSkills/components/overlays/AddDeclaredSkillDrawer/types'
import { EAssociationContextType, EDeclaredSkillLevel, EExternalSkillType } from '@/api/avenir-esr'
import { useDeclaredSkillForm } from '@/features/declaredSkills/components/overlays/AddDeclaredSkillDrawer/use-declared-skill-form/use-declared-skill-form'
