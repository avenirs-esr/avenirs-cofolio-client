...
import type { DeclaredSkillOption } from '@/features/declaredSkills/components/overlays/AddDeclaredSkillDrawer/types'
import type {
  DeclaredSkillForm,
  UpdateDeclaredSkillForm
} from '@/features/declaredSkills/types/forms.types'
...
import DeclaredSkillTypeBadge from '@/features/declaredSkills/components/badges/DeclaredSkillTypeBadge/DeclaredSkillTypeBadge.vue'
