...
} from '@/features/declaredSkills/components/overlays/AddDeclaredSkillDrawer/types'
import type { VueWrapper } from '@vue/test-utils'
import { EExternalSkillType } from '@/api/avenir-esr'
import AddDeclaredSkillAutocompleteField from '@/features/declaredSkills/components/overlays/AddDeclaredSkillDrawer/components/AddDeclaredSkillAutocompleteField/AddDeclaredSkillAutocompleteField.vue'
