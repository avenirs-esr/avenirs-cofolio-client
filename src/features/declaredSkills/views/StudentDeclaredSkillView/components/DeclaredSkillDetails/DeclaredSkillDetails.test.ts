...
import DeclaredSkillDetails, { type DeclaredSkillDetailsProps } from '@/features/declaredSkills/views/StudentDeclaredSkillView/components/DeclaredSkillDetails/DeclaredSkillDetails.vue'
