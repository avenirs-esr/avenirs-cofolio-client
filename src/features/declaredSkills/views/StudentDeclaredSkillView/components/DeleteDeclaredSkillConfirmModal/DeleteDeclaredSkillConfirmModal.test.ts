...
import DeleteDeclaredSkillConfirmModal, { type DeleteDeclaredSkillConfirmModalProps } from '@/features/declaredSkills/views/StudentDeclaredSkillView/components/DeleteDeclaredSkillConfirmModal/DeleteDeclaredSkillConfirmModal.vue'
