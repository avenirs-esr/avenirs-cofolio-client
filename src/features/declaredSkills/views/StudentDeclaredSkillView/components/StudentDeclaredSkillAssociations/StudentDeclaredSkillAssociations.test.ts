...
import { AssociatedTracesCardStub } from '@/features/buildProject/views/ProjectActivityDetailedView/components/cards/AssociatedTracesCard/AssociatedTracesCard.stub'
import { AssociateActivitiesToDeclaredSkillModalStub } from '@/features/declaredSkills/components/overlays/modals/AssociateActivitiesToDeclaredSkillModal/AssociateActivitiesToDeclaredSkillModal.stub'
import { AssociateDeclaredExperiencesToDeclaredSkillModalStub } from '@/features/declaredSkills/components/overlays/modals/AssociateDeclaredExperiencesToDeclaredSkillModal/AssociateDeclaredExperiencesToDeclaredSkillModal.stub'
import { DeleteDeclaredSkillAssociatedActivitiesModalStub } from '@/features/declaredSkills/components/overlays/modals/DeleteDeclaredSkillAssociatedActivitiesModal/DeleteDeclaredSkillAssociatedActivitiesModal.stub'
import { DeleteDeclaredSkillAssociatedTracesModalStub } from '@/features/declaredSkills/components/overlays/modals/DeleteDeclaredSkillAssociatedTracesModal/DeleteDeclaredSkillAssociatedTracesModal.stub'
import StudentDeclaredSkillAssociations
  from '@/features/declaredSkills/views/StudentDeclaredSkillView/components/StudentDeclaredSkillAssociations/StudentDeclaredSkillAssociations.vue'
import { AssociatedDeclaredExperiencesCardStub }
  from '@/features/personalCareer/components/cards/AssociatedDeclaredExperiencesCard/AssociatedDeclaredExperiencesCard.stub'
...
const stubs = {
  ...
  DeleteDeclaredSkillAssociatedTracesModal: DeleteDeclaredSkillAssociatedTracesModalStub
}
...
BddTest().given('a student declared skill associations component', () => {
  ...
  BddTest().when('the component is rendered with deletable declared activities and traces', () => {
    ...
    BddTest().and('the delete dropdown selects the trace type', () => {
      beforeEach(() => {
        const dropdown = findDropdown('delete')
  ...
  BddTest().when('the component is rendered with deletable traces only', () => {
    beforeEach(() => {
      wrapper = mountComponent(StudentDeclaredSkillAssociations, {
        props: {
          declaredSkillId,
          ...
          associatedDeclaredActivities: [],
          associatedDeclaredExperiences: [],
          countAssociations: mockedAssociatedTraces.length
        },
        global: { stubs }
      })
    })
