...
import DeleteActivitiesSelector, { type DeleteActivitiesSelectorProps } from '@/features/global/components/cards/DeleteActivitiesSelector/DeleteActivitiesSelector.vue'
