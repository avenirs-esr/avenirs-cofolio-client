...
import StudentLayout from '@/features/global/layouts/StudentLayout/StudentLayout.vue'
import { StudentNotificationsPopoverStub } from '@/features/user/components/overlays/StudentNotificationsPopover/StudentNotificationsPopover.stub'
import { StudentProfileDropdownStub } from '@/features/user/components/overlays/StudentProfileDropdown/StudentProfileDropdown.stub'
