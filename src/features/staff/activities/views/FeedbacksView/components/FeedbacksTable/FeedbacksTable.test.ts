...
import type { UsePaginatedStaffFeedbacksParams, UsePaginatedStaffFeedbacksResult } from '@/features/staff/activities/composables/use-paginated-staff-feedbacks/use-paginated-staff-feedbacks'
...
vi.mock('@/features/staff/activities/composables/use-paginated-staff-feedbacks/use-paginated-staff-feedbacks', () => ({
