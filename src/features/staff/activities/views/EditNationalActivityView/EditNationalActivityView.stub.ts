...
export const EditNationalActivityViewFormWrapper = defineComponent({
  ...
  setup () {
    const form = useForm({
      defaultValues: { title: 'Test activity', description: '', summary: '' } satisfies EditActivityFormData,
    })
...
export const EditNationalActivityViewFormWrapperDirty = defineComponent({
  ...
  setup () {
    const form = useForm({
      defaultValues: { title: '', description: '', summary: '' } satisfies EditActivityFormData,
    })
