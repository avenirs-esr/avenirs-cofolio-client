...
import { DeleteActivityResourcesConfirmationModalStub } from '@/features/staff/activities/components/modals/DeleteActivityResourcesConfirmationModal/DeleteActivityResourcesConfirmationModal.stub'
