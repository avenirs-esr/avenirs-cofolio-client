...
const allStatusOption = computed<AvTagPickerOption>(() => ({
  label: t('staff.activities.feedbacks.feedbackStatusPicker.all', { count: totalFeedbacks }),
  value: 'ALL'
}))
...
const filterOptions = computed<AvTagPickerOption[]>(() => [
  ...
  {
    label: t('staff.activities.feedbacks.feedbackStatusPicker.new', { count: newFeedbacks }),
    value: EFeedbackStatus.NEW
  },
  {
    label: t('staff.activities.feedbacks.feedbackStatusPicker.unprocessed', { count: unprocessedFeedbacks }),
    value: EFeedbackStatus.IN_PROCESS
  },
  {
    label: t('staff.activities.feedbacks.feedbackStatusPicker.sent', { count: sentFeedbacks }),
