...
import ActivityConsignCard from '@/features/feedbacks/components/cards/ActivityConsignCard/ActivityConsignCard.vue'
import FeedbacksDashboardSection from '@/features/feedbacks/views/ActivityFeedbackDetailsView/components/FeedbacksDashboardSection/FeedbacksDashboardSection.vue'
