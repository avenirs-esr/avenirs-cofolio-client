...
import { useTracePageSizeSelect } from '@/store'
...
const tracePageSizeSelectStore = useTracePageSizeSelect()
const { pageSizeSelected } = storeToRefs(tracePageSizeSelectStore)
...
<template>
  <div class="trace-page-size-select-container">
    <AvSelect
      :options="options"
