...
- Name: tests/student/lifeProject/activityDetails/activityDetails.feature.spec.js >> Student Project Activity Detail Page >> Received feedbacks >> Student can see the received feedbacks section in the my perspective tab for an in progress activity
