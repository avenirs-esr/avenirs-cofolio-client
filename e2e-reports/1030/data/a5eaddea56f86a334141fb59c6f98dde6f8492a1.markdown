...
- Name: tests/student/lifeProject/activityDetails/activityDetails.feature.spec.js >> Student Project Activity Detail Page >> Activity Detail >> Student can see the activity title and description
