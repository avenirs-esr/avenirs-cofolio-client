...
- Name: tests/student/lifeProject/activities/activities.mobile.feature.spec.js >> Student Project Activities Page >> Library activities tab - Mobile display >> Student can navigate to the next page using bottom pagination on mobile
- Location: .features-gen/tests/student/lifeProject/activities/activities.mobile.feature.spec.js:53:5
