...
- Name: tests/student/lifeProject/activityDetails/activityDetails.feature.spec.js >> Student Project Activity Detail Page >> Finish declared activity >> Student with subscribed activity has no finish button and no badge
