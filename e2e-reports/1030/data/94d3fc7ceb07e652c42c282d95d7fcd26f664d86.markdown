...
- Name: tests/student/lifeProject/activityDetails/activityDetails.feature.spec.js >> Student Project Activity Detail Page >> Page Load >> Student can load activity detail page
