...
- Name: tests/student/lifeProject/activityDetails/activityDetails.mobile.feature.spec.js >> Student Project Activity Detail Page (Mobile) >> Activity Detail - Responsive behavior >> No horizontal scrolling on activity detail page
