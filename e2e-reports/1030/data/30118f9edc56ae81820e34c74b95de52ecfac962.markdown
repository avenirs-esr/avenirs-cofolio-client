...
- Name: tests/student/lifeProject/activities/activities.feature.spec.js >> Student Project Activities Page >> Library activities tab - user has no library activities >> Student sees empty state when no activities are registered
- Location: .features-gen/tests/student/lifeProject/activities/activities.feature.spec.js:72:5
