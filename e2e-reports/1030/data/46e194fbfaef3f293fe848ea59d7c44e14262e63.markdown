...
- Name: tests/student/lifeProject/activityDetails/activityDetails.mobile.feature.spec.js >> Student Project Activity Detail Page (Mobile) >> Activity Detail - Responsive behavior >> Student can see activity detail content on mobile
