...
- main:
  - navigation "Fil d'Ariane":
    - list:
      ...
      - listitem: Bâtir mon projet
      - listitem: Me connaître
  - heading "Bâtir mon projet" [level=1]
  - navigation "2005d3f9-2161-4881-894a-b9f3ff52138a navigation":
    - button "Réduire le menu" [expanded]
    - menu:
      - menuitem "Bâtir mon projet":
        - button "Bâtir mon projet"
      - menuitem "Me connaître":
        - button "Me connaître"
      - menuitem "Explorer mes futurs":
        - button "Explorer mes futurs"
      - menuitem "Mes Trajectoires":
        - button "Mes Trajectoires"
  - text: Qui je suis ?
    ...
    - list:
      ...
      - listitem:
        - link "Page suivante":
          - /url: "#page-2"
      - listitem
  - link "Créativité Je suis capable de trouver des solutions originales et innovantes aux problèmes ⭐ ⭐ ⭐ ⭐ ⭐ 5/5":
    - /url: /cofolio/student/project/trajectories/self-knowledge/STRENGTHS?elementId=f107fc47-89e6-4adf-b24b-1be87e867d40
    - text: Créativité
    - paragraph: Je suis capable de trouver des solutions originales et innovantes aux problèmes
    - text: ⭐ ⭐ ⭐ ⭐ ⭐ 5/5
  - link "Esprit d'équipe Je travaille efficacement avec les autres et favorise la collaboration ⭐ 1/5":
    - /url: /cofolio/student/project/trajectories/self-knowledge/STRENGTHS?elementId=1d9b9e32-1814-44b5-8982-b8c876075477
  ...
  - link "Leadership Je sais prendre des initiatives et guider une équipe vers ses objectifs":
    - /url: /cofolio/student/project/trajectories/self-knowledge/STRENGTHS?elementId=6815b2f5-aec1-4ca1-b401-b9da1bb150b4
    - text: Leadership
    ...
    - list:
      ...
      - listitem:
        - link "Page suivante":
          - /url: "#page-2"
      - listitem
  - link "Respect Traiter les autres avec considération et dignité ⭐ ⭐ 2/5":
    - /url: /cofolio/student/project/trajectories/self-knowledge/VALUES?elementId=f7da3522-648a-47d3-9444-6a4de78e87c4
    - text: Respect
    - paragraph: Traiter les autres avec considération et dignité
    - text: ⭐ ⭐ 2/5
  - link "Honnêteté Agir avec intégrité et transparence dans toutes mes interactions ⭐ ⭐ ⭐ 3/5":
    - /url: /cofolio/student/project/trajectories/self-knowledge/VALUES?elementId=b5a63861-a271-487f-899f-46b6deb72941
    - text: Honnêteté
  ...
  - link "Solidarité Soutenir et aider les autres dans le besoin":
    - /url: /cofolio/student/project/trajectories/self-knowledge/VALUES?elementId=6380e530-0cb3-4f06-966c-524fec9f6515
    - text: Solidarité
    ...
    - list:
      ...
      - listitem:
        - link "Page suivante":
          - /url: "#page-2"
      - listitem
  - link "Développer mes compétences techniques Approfondir mes connaissances dans mon domaine d'expertise ⭐ ⭐ ⭐ ⭐ ⭐ 5/5":
    - /url: /cofolio/student/project/trajectories/self-knowledge/ASPIRATIONS?elementId=5cb61ae5-6259-4cd3-8edb-a4d4c570d679
    - text: Développer mes compétences techniques
    - paragraph: Approfondir mes connaissances dans mon domaine d'expertise
    - text: ⭐ ⭐ ⭐ ⭐ ⭐ 5/5
  - link "Manager une équipe Acquérir de l'expérience en gestion et leadership ⭐ 1/5":
    - /url: /cofolio/student/project/trajectories/self-knowledge/ASPIRATIONS?elementId=1d1b4731-9acf-4c63-be94-c690f4c51fba
    - text: Manager une équipe
    - paragraph: Acquérir de l'expérience en gestion et leadership
    - text: ⭐ 1/5
  - link "Voyager à l'étranger Découvrir de nouvelles cultures et élargir mes horizons ⭐ ⭐ ⭐ ⭐ 4/5":
    - /url: /cofolio/student/project/trajectories/self-knowledge/ASPIRATIONS?elementId=de84925f-3932-4c12-9271-62bd2956fdde
