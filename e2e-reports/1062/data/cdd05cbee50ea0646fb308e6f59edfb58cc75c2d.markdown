...
- Name: tests/student/lifeProject/activityDetails/activityDetails.feature.spec.js >> Student Project Activity Page >> Request feedback >> Student with completed activity has no feedback button and finished hint is visible
- Location: .features-gen/tests/student/lifeProject/activityDetails/activityDetails.feature.spec.js:169:5
...
waiting for navigation until "load"
  ...
  navigated to "http://localhost:4173/cofolio/student/activity/declared-activity-3"
  navigated to "http://localhost:4173/cofolio/student/activity/declared-activity-3?section=DETAIL"
============================================================
```
      ...
      - generic [ref=e82]:
        - navigation "Fil d'Ariane" [ref=e83]:
          - list [ref=e85]:
            ...
            - listitem [ref=e91]:
              - generic: Détail
        - 'heading "Détail Activité \"Trajectoires\" : Explorer ses voies" [level=1] [ref=e92]':
          - text: Détail
          - generic [ref=e93]: "Activité \"Trajectoires\" : Explorer ses voies"
      - generic [ref=e95]:
        - status [ref=e96]:
          - generic [ref=e97]: Terminée
        - button "Gérer mon activité" [ref=e100] [cursor=pointer]:
          - generic [ref=e103]: Gérer mon activité
      - generic [ref=e104]:
        - navigation "c78b2e1e-0ff9-4b54-b179-07eaa8eb9dba navigation" [ref=e105]:
        ...
        - generic [ref=e129]:
          ...
          - generic [ref=e148]:
            - generic [ref=e149]:
              - generic [ref=e153]: "Activité \"Trajectoires\" : Explorer ses voies"
              - generic [ref=e154]:
