...
- Name: tests/staff/activities/activitiy-details.feature.spec.js >> Staff Activity Details Page >> Published activity with enrolled students details >> Staff can open a published activity details from the activities table
- Location: .features-gen/tests/staff/activities/activitiy-details.feature.spec.js:35:5
