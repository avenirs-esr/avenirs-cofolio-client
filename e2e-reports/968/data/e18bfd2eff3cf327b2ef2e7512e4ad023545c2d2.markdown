...
- Name: tests/staff/activities/activities.feature.spec.js >> Staff Activities Page >> My workspace tab - Delete activity >> Staff can close the delete confirmation modal from activities list
- Location: .features-gen/tests/staff/activities/activities.feature.spec.js:67:5
