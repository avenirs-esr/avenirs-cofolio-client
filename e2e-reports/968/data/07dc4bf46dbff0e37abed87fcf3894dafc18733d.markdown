...
- Name: tests/staff/activities/activities.feature.spec.js >> Staff Activities Page >> My workspace tab - Unpublish activity >> Staff can open the unpublish confirmation modal from activities list
- Location: .features-gen/tests/staff/activities/activities.feature.spec.js:86:5
