...
- Name: tests/staff/activities/activities.feature.spec.js >> Staff Activities Page >> My workspace tab >> Staff can see the my workspace table
- Location: .features-gen/tests/staff/activities/activities.feature.spec.js:30:5
