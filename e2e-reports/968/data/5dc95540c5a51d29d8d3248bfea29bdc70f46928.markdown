...
Locator: locator('[data-testid="access-button"][data-feedback-status="IN_PROCESS"]').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="access-button"][data-feedback-status="IN_PROCESS"]').first()
