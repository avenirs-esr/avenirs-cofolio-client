...
- Name: tests/staff/home.feature.spec.js >> Staff Home Page >> Published activities widget >> Published activity cards are clickable and navigate to the published activity details page
- Location: .features-gen/tests/staff/home.feature.spec.js:99:5
...
Locator: getByTestId('published-activities-widget')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByTestId('published-activities-widget')
