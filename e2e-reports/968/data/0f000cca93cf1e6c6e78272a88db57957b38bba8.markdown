...
Locator: locator('header').getByTestId('main-navigation').locator('nav').locator('[data-testid="nav-router-link"][href="/cofolio/staff"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('header').getByTestId('main-navigation').locator('nav').locator('[data-testid="nav-router-link"][href="/cofolio/staff"]')
