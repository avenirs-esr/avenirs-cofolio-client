...
- Name: tests/staff/activities/edit-national-activity.feature.spec.js >> Staff Edit National Activity Page >> Managing activity resources >> The delete resources button is disabled when no resource is selected
- Location: .features-gen/tests/staff/activities/edit-national-activity.feature.spec.js:276:5
