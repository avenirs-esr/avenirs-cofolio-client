...
- Name: tests/staff/activities/activitiy-details.feature.spec.js >> Staff Activity Details Page >> First activity >> Staff can open an activity details from the activities table
- Location: .features-gen/tests/staff/activities/activitiy-details.feature.spec.js:17:5
