...
- Name: tests/staff/home.feature.spec.js >> Staff Home Page >> Profile Section >> Staff can see profile section
- Location: .features-gen/tests/staff/home.feature.spec.js:34:5
...
Locator: getByTestId('staff-overview-widget')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByTestId('staff-overview-widget')
