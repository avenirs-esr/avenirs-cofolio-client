...
- Name: tests/student/lifeProject/selfKnowledge/selfKnowledge.mobile.feature.spec.js >> Student Project Self-Knowledge Main Section Page >> Responsive Behavior >> Self-knowledge section title is displayed
- Location: .features-gen/tests/student/lifeProject/selfKnowledge/selfKnowledge.mobile.feature.spec.js:12:5
...
Locator:  getByTestId('self-knowledge-section-title')
Expected: "student.selfKnowledge.SelfKnowledgeMainSection.title.content"
Received: "Me connaître"
Timeout:  10000ms

Call log:
  - Expect "toHaveText" with timeout 10000ms
  - waiting for getByTestId('self-knowledge-section-title')
    24 × locator resolved to <div data-v-34b0be62="" data-testid="self-knowledge-section-title" class="icon-text--container av-row av-align-start ellipsis-container">…</div>
       - unexpected value "Me connaître"
...
```ts
  ...
  9   | 
  10  | export
  11  | @Fixture<typeof test>('studentBuildProjectSelfKnowledgePage')
  12  | class StudentBuildProjectSelfKnowledgePage extends BasePage {
  ...
  60  |   async goto () {
  61  |     await this.page.goto(STUDENT_ROUTES.PROJECT.BUILD_PROJECT.SELF_KNOWLEDGE)
  ...
  70  |     await expect(this.page).toHaveURL(STUDENT_ROUTES.PROJECT.BUILD_PROJECT.SELF_KNOWLEDGE)
  71  |   }
  72  | 
