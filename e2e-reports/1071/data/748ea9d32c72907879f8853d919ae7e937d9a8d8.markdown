...
- Name: tests/student/lifeProject/activitiesCatalog/activitiesCatalog.mobile.feature.spec.js >> Student Project Activities Catalog Page >> Activities Navigation - Mobile >> Student sees all expected thematics in select navigation
- Location: .features-gen/tests/student/lifeProject/activitiesCatalog/activitiesCatalog.mobile.feature.spec.js:22:5

# Error details

```
Error: Missing optgroup for thematic: OTHER

expect(locator).toHaveCount(expected) failed

Locator:  locator('select[data-testid="activities-select-navigation"]').locator('[data-testid="select-optgroup-OTHER"]')
Expected: 1
Received: 0
Timeout:  10000ms

Call log:
  - Missing optgroup for thematic: OTHER with timeout 10000ms
  - waiting for locator('select[data-testid="activities-select-navigation"]').locator('[data-testid="select-optgroup-OTHER"]')
